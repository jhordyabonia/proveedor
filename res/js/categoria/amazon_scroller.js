...
(function(a){
    a.fn.amazon_scroller=function(p){
        ...
        dom.find(".amazon_scroller_nav").children("li").hover(
            function(){
                if($(this).parent().children().index($(this))==0){
                    ...
                    $(this).css("background-image", "url('img/pag_anterior_ok.png')");
                }else if($(this).parent().children().index($(this))==1){
                    //$(this).css("background-position","right -50px");
                    $(this).css("background-image", "url('img/pag_siguiente_ok.png')");
                }
            },
            function(){
                if($(this).parent().children().index($(this))==0){
        ...
        function s_s_nav(a,d){
            ...
            a.children("li").css("width","18px"); //a.children("li").css("width","25px");
            a.children("li").css("height","24px"); //a.children("li").css("height","50px");
            a.children("li").css('background-image','url("'+d+'/paginas_scroller.png")');
