...
*/
function setSongPosition(obj, e, porcentajeAumento, nivel){
    ...
    //sistema personalizado para mejorar el sistema de seek
    //la variable "percentage" es el porcentaje de la barra de seek
    //p.ej. [||--------] seria 20% o 0.20
    //de una barra de 0 a 1
    //la variable de control "porcentajeAumento" permite conocer si al hacer clic 
    //en "rew" se disminuye 0.20 niveles, entonces la variable es 1
    //lo contrario es si la variable es 2, se aumenta 0.20 niveles
    if (porcentajeAumento == 1) { //REW
        percentage = (nivel / songSliderWidth);
    } else if (porcentajeAumento == 2) { //FF
        percentage = (nivel / songSliderWidth);
    } else {
        percentage = (clickLocation/songSliderWidth);
    }

    //establecer la cancion en el nivel deseado, haya sido manipulando bien sea 
    //la barra seek o pulsando rew o ff
