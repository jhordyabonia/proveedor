<div class="login">
<?=form_open_multipart('oferta_test/eliminar/'.$id_solicitud);  ?>
<link rel="stylesheet" type="text/css" href="<?php echo css_url()?>styles_login.css">
           ...
           <div class="modal-dialog">
              <div class="modal-content modal-content-login modal-content-four">
                <div class="modal-header">
                  ...
                  <h5 class="text-center">¿En realidad desea eliminar esta solicitud?</h5>
