...
<html>
   <head>
      ...
      <title>Correo Proveedor.com.co</title>
      <style type="text/css">
         ...
         text-decoration: none;
         color: #0033FF; /* or whatever your want */
         pointer-events: none;
         cursor: default;
         }
   ...
   <body>
<!-- Start of preheader -->
<table width="100%" bgcolor="#ff7f27" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" style="border-left: 1px solid #ccc;  border-right: 1px solid #ccc; border-top: 1px solid #ccc; ">
   <tbody>
      <tr>
         <td>
                                    ...
                                    <table width="70" align="center" border="0" cellpadding="0" cellspacing="0" >
                                       <tbody>
                                          <tr>
                                             <td>
                                                <a href="<?=base_url()?>">
                                                   <img src="<?=img_url()?>email/logo_complete2.png">
                                                </a>
                                             </td>
                                          </tr>
                                       </tbody>
...
<table width="100%" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" style="border-left: 1px solid #ccc;  border-right: 1px solid #ccc; ">
   <tbody>
      <tr>
         <td>
            <table width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
               <tbody>
                  <tr>
                     <td width="100%">
                        <table bgcolor="#ffffff" width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                           <tbody>
                              <!-- Spacing -->
                              <tr>
                                 <td width="100%" height="50" align="center">
                                    <a href="<?=$url_mensaje?>" style="font-family: Helvetica; font-size: 12px;">
                                       Haz clic aqui si no puedes visualizar este mensaje
                                    </a>   
                                 </td>
                              </tr>
                              <!-- Spacing -->
                              <tr>
                                 <td>
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="margin-top: 20px;">
                                       <tbody>
                                          <!-- Title -->
                                          <tr>
                                          ...
                                          <!-- content -->
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 17px; color: #9F9F9F; text-align:center;line-height: 24px;font-weight: 600;">
                                                <?=$asunto?>
                                                <br>
         ...
         <td>
            <table width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
               <tbody>
                  <tr>
                     <td width="100%">
                        <table bgcolor="#ffffff" width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" style="margin: 10px 0px 20px;">
                           <tbody>
                              <tr>
                                 <td>
                                    <table width="340" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth" style="background: #f7f7f7; margin-right: 20px; margin-left: 20px;">
                                       <tbody>
                                          <tr>
                                             <td>
                                                <!-- start of text content table -->
                                                <table width="650" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner" style="margin: 30px;">
                                                   <tbody>
                                                      <!-- image -->
                                                      <tr>
                                                      ...
                                                      <!-- button -->
                                                      <tr>
                                                         <td style=" font-family: Helvetica, arial, sans-serif; font-size: 14px; font-weight:bold; color: #333333; text-align:center;line-height: 24px;">
                                                            
                                                            <br>
                                                               <a href="<?=$url_mensaje?>" 
                                                               style="text-decoration: none;color: #FFF;  background-color: #ff7f27;  
                                                               padding: 15px 60px;  font-weight: bold;  margin-right: 10px;  
                                                               text-align: center;  cursor: pointer;  display: inline-block;  
                                                               border-radius: 5px;">
                                                                  Ver Mensaje / Responder <br> <? if($adjunto):?>Tiene un archivo adjunto<? endif;?>
                                                               </a>
...
<!-- Start of postfooter -->
<table width="100%" bgcolor="#ff7f27" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" style="box-shadow: 0px 0px 5px rgba(0,0,0,0.50); border-left: 1px solid #ccc;  border-right: 1px solid #ccc; border-bottom: 1px solid #ccc; ">
   <tbody>
      <tr>
         <td>
            <table width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
