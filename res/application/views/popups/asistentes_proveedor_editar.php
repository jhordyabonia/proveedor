...
<?=form_open_multipart('tablero_usuario/editar_solicitud_externa/'.$solicitud->id);  ?>
          ...
          <!-- vista para tamaño lg -->
              ...
              <div class="modal-header encabezado hidden-xs hidden-sm hidden-md visible-lg">
                ...
                <div class="modal-body text-center popup_central">
                  ...
                  <p class="texto_superior">Verifique la información de la solicitud, y haga click en el botón  "Activar y publicar"</p>

                  <p class="texto_superior_2"></p>
                 ...
                 <?php if($datos->campos!=str_replace('email',"",$datos->campos)):?>
                  ...
                  <div class="input-group">
                    ...
                    <input type="email" class="form-control tam_caja" disabled placeholder="<?=$datos->titulos['email']?>" name="email" value="<?=$solicitud->email?>" required>
                ...
                <?php endif;?>
                 ...
                 <label for="Producto" class="label_modal hidden-xs hidden-sm"><?=$datos->titulos['nombre']?>:<span class="fa fa-asterisk asterisk_label"></span></label><br>
                  ...
                  <div class="input-group producto_insumo">
                    ...
                    <input type="text" class="form-control tam_caja" placeholder="<?=$datos->titulos['nombre']?>" name="solicitud" value="<?=$solicitud->solicitud?>" required>
                ...
                <?php endif;?>
                 ...
                 <?php if($datos->campos!=str_replace('cantidad',"",$datos->campos)):?>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control texto_cantidad tam_caja" placeholder="<?=$datos->titulos['cantidad']?>" name="cantidad_requerida" value="<?=$solicitud->cantidad_requerida?>" required>
                ...
                <?php endif;?>
                 ...
                 <?php if($datos->campos!=str_replace('descripción',"",$datos->campos)):?>
                  ...
                  <div class="col-xs-12 input-group">
                    ...
                    <textarea class="form-control caja_mensaje" placeholder="<?=$datos->titulos['descripción']?>" name="descripcion" rows="4" required><?=$solicitud->descripcion?></textarea>
                ...
                <?php endif;?>
                 ...
                 <?php if($datos->campos!=str_replace('precio',"",$datos->campos)):?>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control texto_precio tam_caja" placeholder="<?=$datos->titulos['precio']?>" name="precio" value="<?=$solicitud->precio?>">
                ...
                <?php endif;?>
                 ...
                 <?php if($datos->campos!=str_replace('pago',"",$datos->campos)):?>
                  ...
                  <div class="input-group">
                    ...
                    <select <?=set_select($solicitud->forma_de_pago)?> name="pago" class="form-control formas_de_pago">

                      <option <?=set_select($solicitud->forma_de_pago)?> value="No seleccionado"> <?=$datos->titulos['pago']?></option>

                      <option <?=set_select($solicitud->forma_de_pago)?> value="Transferencia bancaria">Transferencia bancaria</option>

                      <option <?=set_select($solicitud->forma_de_pago)?> value="Giros Nacionales">Giros Nacionales</option>

                      <option <?=set_select($solicitud->forma_de_pago)?> value="Cheque">Cheque</option>

                      <option <?=set_select($solicitud->forma_de_pago)?> value="Efectivo">Efectivo</option>

                      <option <?=set_select($solicitud->forma_de_pago)?> value="Contraentrega">Contraentrega</option>

                      <option <?=set_select($solicitud->forma_de_pago)?> value="A convenir">A convenir</option>
                ...
                <?php endif;?>
                 ...
                 <?php if($datos->campos!=str_replace('empresa',"",$datos->campos)):?>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control texto_empresa tam_caja" placeholder="<?=$datos->titulos['empresa']?>" name="nombre_empresa" value="<?=$solicitud->nombre_empresa?>">
                ...
                <?php endif;?>
                 ...
                 <?php if($datos->campos!=str_replace('contacto',"",$datos->campos)):?>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control tam_caja" placeholder="<?=$datos->titulos['contacto']?>" name="nombres" value="<?=$solicitud->nombres?>" required>
                ...
                <?php endif;?>
                 ...
                 <?php if($datos->campos!=str_replace('teléfono', "",$datos->campos)):?>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control tam_caja" placeholder="<?=$datos->titulos['teléfono']?>" name="telefono" value="<?=$solicitud->telefono?>" required>
                ...
                <?php endif;?>
                 ...
                 <?php if($datos->campos!=str_replace('ciudad', "",$datos->campos)):?>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control texto_ciudad tam_caja" placeholder="<?=$datos->titulos['ciudad']?>" name="ciudad_entrega" value="<?=$solicitud->ciudad_entrega?>" required>
                ...
                <?php endif;?>
                  ...
                  <div class="col-md-12 input-group enviar">
                    ...
                    <button type="submit" class="btn btn-default center-block boton_enviar">Activar y publicar</button>

                  </div>

                  <input type="hidden" class="form-control texto_ciudad tam_caja" placeholder="" name="categoria" value="<?=$solicitud->categoria?>">
         </div>                
