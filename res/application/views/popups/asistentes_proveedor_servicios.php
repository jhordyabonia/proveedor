          ...
          <!-- vista para tamaño lg -->
              ...
              <div class="modal-header encabezado hidden-xs hidden-sm hidden-md visible-lg">
                ...
                <div class="modal-body text-center popup_central">
                 ...
                 <label for="Producto" class="label_modal">Servicio solicitado: ( Ejemplo: Coaching Empresarial, Coaching Financiero...)<span class="fa fa-asterisk asterisk_label"></span></label><br>
                  <div class="input-group producto_insumo">
                    <span class="input-group-addon">
                      <span class="fa fa-shopping-cart" aria-hidden="true"></span>
                    </span>
                    <input type="text" class="form-control tam_caja" placeholder="Coaching Empresarial, coaching ejecutivo grupal, coaching ejecutivo individual, Otro tipo de Coaching..." name="solicitud" value="" required>
                  </div> 
