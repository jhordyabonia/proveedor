	...
	<body>
		<div class="container" style="padding: auto; margin: auto;">
			...
			<div class="row" id="fuentesubtitulo"> 
				...
				<div class="col-md-2" style="width:15%;padding-right:0;">
					<br> <br>
					<p class="text-right">Sector o categoría de <br> la empresa <br><br> Máximo 5 </p>
				</div>

				<div class="col-md-3">
					<select name="categorias" id="categoria" multiple="multiple" size="9" style="width: 85%;" >
						<?php foreach ($categorias as $row): ?> 
							<?php echo '<option>('. $row->id_categoria .')'.$row->nombre_categoria .'</option>'; ?>
						<?php endforeach; ?>
					</select>
					 <script type="text/javascript">
				...
				<div class="col-md-1" style="padding-right:0; padding-left:0;">
					<br> <br>
					<input type="button" value="Pasar »"  onclick="JavaSript:agregar_categoria(categorias.value);"
					 id="pasar" name="pasar" style="width: 80%;" class="pasar izq" >				
					<input  type="button" value="« Quitar"  onclick="JavaSript:eliminar_categoria();"
					id="quitar" name="quitar"  style="width: 80%;" class="quitar der">
					<input  type="hidden" id="numero_base" value="0">
				    <input  type="hidden" id="numero_categorias" name="numero_categorias" value="0">
				    <input  type="hidden" id="id_categorias" name="id_categorias" required value="">
				    <input  type="hidden" id="nombre_categorias" name="nombre_categorias" required value="">
     
				</div>

				<div class="col-md-3">
					<select name="textarea2" id="textarea2"  multiple="multiple" size="9" placeholder="Categorías seleccionadas" style="width: 85%;">
