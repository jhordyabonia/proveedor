		    								...
		    								<!--
		    	    							<center>
													<nav>
													  <ul class="pagination">
														<? if($page>0): ?>
															<li><a href="<?=base_url()?>categoria/ver/<?=$categoria->id_categoria?>/0/productos/<?=$page-1;?>">&laquo; Anterior </a></li>
														<?php endif; ?>
														<? for($i=0;$i<$page_count;$i++): ?>
															<li <?php if($page==$i){echo "class='pagina_actual'";}?>>
																<a href="<?=base_url()?>categoria/ver/<?=$categoria->id_categoria?>/0/productos/<?=$i?>"><?=$i+1?></a>
															</li>
														<?endfor;?>
														<? if($page<intval($page_count)): ?>
															<li><a href="<?=base_url()?>categoria/ver/<?=$categoria->id_categoria?>/0/productos/<?=$page+1?>">Siguiente &raquo;</a></li>
													  	<?php endif; ?>
													  </ul>
													</nav>
												</center>
		    	...
		    	?>							<!--
		    									<center>
													<nav>
													  <ul class="pagination">
														<? if($page>0): ?>
															<li><a href="<?=base_url()?>categoria/ver/<?=$categoria->id_categoria?>/proveedores/0/<?=$page-1;?>">&laquo; Anterior </a></li>
														<?php endif; ?>
														<? for($i=0;$i<$page_count2;$i++): ?>
															<li <?php if($page==$i){echo "class='pagina_actual'";}?>>
																<a href="<?=base_url()?>categoria/ver/<?=$categoria->id_categoria?>/proveedores/0/<?=$i?>"><?=$i+1?></a>
															</li>
														<?endfor;?>
														<? if($page<intval($page_count2)): ?>
															<li><a href="<?=base_url()?>categoria/ver/<?=$categoria->id_categoria?>/proveedores/0/<?=$page+1?>">Siguiente &raquo;</a></li>
													  	<?php endif; ?>
													  </ul>
													</nav>
												</center>
		    	...
		    	?>
		    								...
		    								<center>
													<nav>
													  <ul class="pagination">
														<? if($page>0): ?>
															<li><a href="<?=base_url()?>categoria/ver/<?=$categoria->id_categoria?>/0/solicitudes/<?=$page-1;?>">&laquo; Anterior </a></li>
														<?php endif; ?>
														<? for($i=0;$i<$page_count3;$i++): ?>
															<li <?php if($page==$i){echo "class='pagina_actual'";}?>>
																<a href="<?=base_url()?>categoria/ver/<?=$categoria->id_categoria?>/0/solicitudes/<?=$i?>"><?=$i+1?></a>
															</li>
														<?endfor;?>
														<? if($page<intval($page_count3)): ?>
															<li><a href="<?=base_url()?>categoria/ver/<?=$categoria->id_categoria?>/0/solicitudes/<?=$page+1?>">Siguiente &raquo;</a></li>
													  	<?php endif; ?>
													  </ul>
													</nav>
												</center>
