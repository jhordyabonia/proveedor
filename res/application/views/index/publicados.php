...
<!-- Contenido derecho ultimos productos publicados -->
<ul id="movimiento2">
	<?php foreach ($prod_publicados as $row): ?>
		<li>
			<table width="415px"> <tr>
					<td style="width: 130px; height: 106px; padding: 5px 5px 5px 5px; vertical-align: middle; max-height: 90px; text-align: center;"> 
						<a href="<?= base_url() ?>producto/ver/<?= $row->id_producto; ?>/<?= $row->id_usuario; ?>">
							<img src="<?= base_url() ?>uploads/<?= $row->nombre_img ?>" class="imgProd" /> 
						</a>
					</td>
					<td width="auto" style="padding: 5px 5px 5px 5px;"> 
						<a href="<?= base_url() ?>producto/ver/<?= $row->id_producto; ?>/<?= $row->id_usuario; ?>">
							<p style="color: #3aa2ed; font-size: 15px; text-align: center;" > 
								<?= $row->nom_producto; ?></p> </a>
				<center> 
					<table style="padding-top: 14px;"> <tr>
						...
						<tr> <td> <center> <img src="img/sonrisaprecio.png" 
												style="margin-top: -6px;" /> </center> </td>
						</tr>
					</table> </td>
				</tr> </table> </center>
			<p style="margin-top: -5px; color: gray; font-size: 15px; text-align: center; padding-top: 4px;"> 
				<?= $row->pedido_min; ?> unidades </p>
