...
<html lang = "es">
  	<head>
		...
		<title> <?php echo $nombre_producto->nom_producto;?> / PROVEEDOR.com.co</title>
		...
		<!-- http://www.htmldrive.net/items/show/1166/Awesome-jQuery-Camera-slideshow-plugin -->
		<!-- <link rel='stylesheet' id='camera-css'  href='<?=base_url()?>css/camera.css' type='text/css' media='all'> 
		...
		<script type='text/javascript' src='<?=base_url()?>js/camera.js'></script> 
		<!-- edicion personalizada en camera.js (linea 461 a 468) para que la imagen no se redimensionara al 100% -->
		<!-- <style type="text/css">
			#back_to_camera {
				clear: both;
				display: block;
		...
		<script type="text/javascript">
			jQuery(function(){
				//crear el(los) objeto(s) visor(es) de foto(s)
		...
		<div class="container_12" >
			...
			<iframe src="<?=base_url()?>header" scrolling="no" id="header_iframe"></iframe>
		  	...
		  	<!-- header 2 -->
				<div class="grid_1" id="espacio_logo_proveedor"> 
					<a href="#"> <img src="<?=base_url()?>img/logo3.png" /> </a> 
				</div> 

				<div class="grid_1" id="titulito">
					<b style="font-size: 12px; color:#7f7f7f;">
						¡Publica Gratis tus Productos y tus Solicitudes de Productos!</b>
				</div>
					...
					<table style="width: auto; height: auto;">
						<tr>
							...
							<td style="height: 50px;">
								<table style="width: auto; height: auto;">
									<tr>
										<td style="height: auto; padding-right: 8px;"> <!-- href="<?=$publicar_of?>" -->
											<a href="#" <?=@$clase_css?>> 
												<img src="<?=base_url()?>img/boton_oferta.png" /> </a>
										</td>
										<td style="height: auto"> <!-- href="<?=$publicar_prod?>" -->
											<a href="#" <?=@$clase_css?>> 
			...
			<div class="grid_1" id="ho">
				<p style="font-size: 12px">
					Home > <a href="#"> Products </a> > <a href="#"> Computer Hardware & Software </a> >
						<a href="#"> Monitors </a> > <a href="#"> LCD Monitors </a> (295263)
				</p>
			</div>
			...
			<article> <section>
				...
				<?php
					/* 
						<div class="grid_4" id="div1">
							<!-- NOTA IMPORTANTE -->
							<!-- el plugin de visualizacion de las imagenes requiere que las imagenes sean  -->
							<!-- grandes, pues por defecto las imagenes muy pequeñas se redimensionan al tamaño del contenedor -->
							<table width="auto">
								<?php  foreach ($img_principal as $row): ?> <!--Este ciclo trae de la bd el nombre de la imagen -->
								<tr> <td style="width: 322px; max-width: 322px; border: 4px solid #ddd;">
									<div class="camera_wrap camera_blue_skin" id="camera_wrap_2" style="width: 322px;">
										<div data-thumb="<?=base_url()?>uploads/<?php echo $row->nombre_img;?>" data-src="<?=base_url()?>uploads/<?php echo $row->nombre_img;?>">
					...
					<table width="auto">
						<tr> <td style="width: 322px; max-width: 322px; height: 360px;">
							<div class="sp-wrap"> <!-- maximo 8 imagenes -->
								<!-- <a href="<?=base_url()?>img/cosaazul.png"> <img src="<?=base_url()?>img/cosaazul.png" alt=""> </a>
								<a href="<?=base_url()?>img/memorias_usb.png"> <img src="<?=base_url()?>img/memorias_usb.png" alt=""> </a>
								<a href="<?=base_url()?>img/ruedagris.png"> <img src="<?=base_url()?>img/ruedagris.png" alt=""> </a>
								<a href="<?=base_url()?>img/puerta.png"> <img src="<?=base_url()?>img/puerta.png" alt=""> </a>
								<a href="<?=base_url()?>img/arroz.png"> <img src="<?=base_url()?>img/arroz.png" alt=""> </a>
								<a href="<?=base_url()?>img/maquinaria.png"> <img src="<?=base_url()?>img/maquinaria.png" alt=""> </a> -->
								<?php  foreach ($img_principal as $row): ?> <!--Este ciclo trae de la bd el nombre de la imagen -->
			  	...
			  	<div class="grid_4" id="div2">
				  					...
				  					<td width="33.3%" style="vertical-align: middle; ">
				  						<table width="auto" style="float: right;"> <tr>
				  							...
				  							<td style="padding-right: 5px;"> 
				  								<p style="font-weight: bold; font-size: 18px;"> <?php echo $precio_producto->precio_unidad;?> </p> </td>
				  						</tr> </table>
				  					</td>
				  					<td width="33.3%" style="vertical-align: middle;">
				  						<table width="auto"> <tr>
				  							...
				  							<td style="padding-right: 15px; font-size: 16px; padding-top: 20px;"> 
				  								<?= $pedido_min->pedido_min;?> unidades</td>
				  						</tr> </table>
				  					</td>
				  					...
				  					<td colspan="2" style="padding: 13px 10px 4px 29px; font-size: 13px;">
				  						<table width="100%" style="border-collapse: separate; border-spacing: 0px; font-size: 12px;"> 
				  							...
				  							<tr>
					  							...
					  							<td width="50%" style="padding-top: 8px;"> <p id="capacproduccion"> 500 unidades X semana</p> </td>
				  							</tr>
				  							<tr>
					  							<td width="50%" style="padding-top: 8px; font-weight: bold; text-align: left; padding-right: 10px; color:#7f7f7f;"> 
					  								Forma de pago: </td> 
					  							...
					  							<td width="50%" style="padding-top: 8px; font-weight: bold; text-align: left; padding-right: 10px; color:#7f7f7f;"> 
					  								Ubicacion: </td> 
					  							<td width="50%" style="padding-top: 8px;"> <p id="origendesp"> <?= $origen_despacho->ubicacion;?> </p> </td>
				  							</tr>
				  							<tr>
					  							<td width="50%" style="padding-top: 8px; font-weight: bold; text-align: left; padding-right: 10px; color:#7f7f7f;"> 
					  								Estado: </td> 
					  							<td width="50%" style="padding-top: 8px;"> <p id="estadoproducto"> Nuevo </p> </td>
				  							</tr>
				  							<!--<tr>
				  				...
				  				<tr>
				  					<td colspan="4">
				  						<div style="margin-left: 28px; margin-top: 24px;">
				  						   <input type="image" name="boton"   src="<?=base_url()?>img/cotizar.png" />
					...
					<div class="grid_2" style="width: 412px; height: auto; background: transparent; border-top: 2px solid #f3f3f4; margin: 5px -181px 0px -8px;">
						<div style="padding: 11px 10px 10px 119px; font-size: 13px;">	
							...
							<p style="color: #00a2e8; font-size: 19px; font-weight: bold; padding-bottom: 10px; padding-bottom: 96px; margin-top: -90px"> 
								<?=$info_empresa->nombre?> </p>
							<table width="100%" style=" border-collapse: separate; border-spacing: 0px; font-size: 12px; margin-top: -90px;">
								<tr>
									<td style="padding-right: 10px; padding-bottom: 9px;"> <img src="<?=base_url()?>img/contacto.png" /> <a href="#" style="margin-left: 5px; font-size: 15px; pñ0"> Información de Contacto </a></td>
								</tr>
								...
								<tr> <td style="font-size: 12px;"> <b> Productos principales: </b> 
									<?php  foreach ($otros_pro as $row): 
										echo $row->nombre_producto.' ';?>
			  						<?php  endforeach; ?>
								 </td> </tr>
								<tr> <td style="padding-top: 10px; font-size: 12px;"> <b> Productos publicados: </b> <a href="#"> <?php echo $prod_publicados;?> - Ver productos </a> </td> </tr>
							</table>
						</div>
					</div>
					  				...
					  				<tr>
					  					<td style="width: 823px; max-width: 865px; font-size: 13px; padding-top: 26px;">
											...
											<div id="content"> 
												<div id="tab1">
													<!-- PESTAÑA 1    -->
												    <?php foreach($desc_empresa as $dato): 
				...
				<div class="grid_2" id="botonazul_ofcompra">
					<a href="#" > <img src="<?=base_url()?>img/boton_pro_2.png" /></a>
				</div>
							...
							<div class="grid_2 " style="margin-left: 0px; height: auto; width: 677px; background: transparent;">
								<div style="font-size: small;"> 
									...
									<!-- Mensaje de validacion para el formulario de mensaje -->
										...
										<?=form_open_multipart('control_producto/enviar/'.$producto.'/'.$imagen_producto.'/'.$id_user) ?> 
										...
										<tr>
											...
											<td class="subtitulo"> 
												...
												<input type="text" name="from" style="width: 196px; height: 26px; margin-left: 0px; border: 1px solid #ddd;" /> </td>
											<td> 
										...
										<tr>
											...
											<td class="subtitulo"> 
												...
												<input type="text" name="tel" style="width: 196px; height: 26px; margin-left: 0px; border: 1px solid #ddd;" /> </td>
											<td> 
										...
										<tr>
											...
											<td class="subtitulo"> 
												...
												<textarea rows="10" name="msj" cols="50" style="margin-left: 0px; width: 495px; height: 103px; border: 1px solid #ddd; resize: none; font-family: Arial;"></textarea> </td>
										</tr>
										<tr> <td style="padding-top: 10px;"> </td> </tr>
										<tr>
				...
				<iframe src="<?=base_url()?>footer" scrolling="no"  
					style="height: 333px; width: 100%; margin-left: 0px;"> </iframe>
				</div>
			</section> </article>
		</div>
	</body>
