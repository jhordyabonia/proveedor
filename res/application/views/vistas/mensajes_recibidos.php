					...
					<div class="grid_4" id="div1">
						<div class="grid_2 alpha" style="margin-top: 30px; background-color: transparent;">
							<div class="grid_2 alpha" style="background-color: transparent;">
								<a href="#"> <img src="<?=base_url()?>img/mensajesrecibidos_2.png" /> </a> 
								<br> <br>
								<a href="<?=base_url()?>mensajes_usuario/enviados"> <img src="<?=base_url()?>img/mensajesenviados.png" /> </a>
							</div>
						</div>
					</div>
								...
								<!-- *********************************************************************** -->
									<?php  foreach ($msj as $row): 												              
										...
										<tr class="msj noleido" style="border-bottom: 10px solid white;">
											...
											<td class="msj texto" width="20%"> <?= $row->estado;?> <img src="<?=base_url()?>img/cartamensaje_2.png" /> </td>
										</tr>
