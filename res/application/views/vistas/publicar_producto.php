   ...
   <!-- own imports -->
    ...
    <script src="<?= base_url() ?>assets/js/publicar_producto/edicionproducto_js.js"></script>
     <div class="row">
       <!-- sidebar -->
          ...
          <div class="col-md-10 col-sm-10">
            ...
            <div class="row">
              ...
              <div class="col-md-2 col-sm-4 col-xs-5">
                <select class="form-control" id="combo1" name="list_medidas" disabled="true">
      ...
      <option value="Hora">Hora</option>
            ...
            <div class="row">
              ...
              <div class="col-md-2 col-sm-3 col-xs-6">
                <select class="form-control" id="combo_tipo" name="tipo" disabled="true">
                </select>
              </div>
              <div class="col-md-2 col-sm-3 col-xs-6">
                <select class="form-control" id="combo_sector" name="sector" disabled="true">
                </select>
              </div>
            </div>
