...
<html lang = "es">
  	...
  	<head>
		...
		<title>Búsqueda / PROVEEDOR.com.co</title>
      ...
      <link rel="stylesheet" href="<?=base_url()?>css/listados/pagination.css" />
		...
		<!-- busqueda la pagina abrira la pestaña 1,2 o 3 -->
...
echo'
	...
	["uploads/resizelogos/'.@$value->logo.'", "'.@$value->nombre.'",
				...
				$("ul.tabs li a").click(function(e) {
					...
					if ($(this).attr("title") == "Productos") {
						...
						$('#preg_satis').html('<div style="text-align: center; margin-bottom: 1.5em;">' 
							...
							+ '¿No encontraste lo que estabas buscando? </p> </div>' 
						...
						$('#titulo_cont').html('Venta al por mayor de cobre en Colombia -'
							...
							+ 'Precio y catálogo de productos');

						$('#subtitulo_cont').html('Se muestra a continuación el catálogo de productos al '
						...
						$('#preg_satis').html('<center> <div style="width: 45em;"> <div style="float: left;">'
							...
							+ '¿Quiere aparecer en este listado? </p> </div> <div style="text-align: center;">'
						...
						$('#preg_satis').html('<center> <div style="width: 45em;"> <div style="float: left;">'
							...
							+ '¿Quiere conseguir más clientes? </p> </div>' 
						...
						$('#subtitulo_cont').html('Encuentre compradores de <b>cobre</b> '
							...
							+ 'Contacte posibles clientes interesados que demandan éste producto '
		 	...
		 	<article> <section>
				...
				<div class="grid_4" id="div2">
					...
					<div class="grid_4" id="margen">
						...
						<!-- por defecto aparecen los elementos de la primer pestaña -->
				...
				<div class="grid_4" id="div1">
				   ...
				   <div class="grid_4" style="width: 198px; height: auto; background: #fff; padding: 5px 0px 5px 0px; margin: 0 0 1em 0; border: 4px solid #f7f7f7;">
				      ...
				      <b style="margin-left:12px; font-size:13px;"> Categorías </b>

				      <ul style="margin: 0.5em 0 0.4em 0; line-height: 2.3em;">

							<li type="disc" style="margin-left: 30px; color: gray;"> 

								<a href="#" style="color: blue"> Minería y Metalurgia <font style="color:gray; font-size: 11px;"> (100) </font> </a> </li>
							...
							<li type="disc" style="margin-left: 30px; color: gray;">
								...
								<a href="#" style="color: blue"> Productos químicos <font style="color:gray; font-size: 11px;"> (30) </font> </a> </li>
							...
							<li type="disc" style="margin-left: 30px; color: gray;">
								...
								<a href="#" style="color: blue"> Energía <font style="color:gray; font-size: 11px;"> (10) </font> </a> </li>

							<li type="disc" style="margin-left: 30px; color: gray;">

								<a href="#" style="color: blue"> Electrodomésticos <font style="color:gray; font-size: 11px;"> (5) </font> </a> </li>

							<li type="disc" style="margin-left: 30px; color: gray;">

								<a href="#" style="color: blue"> Construcción <font style="color:gray; font-size: 11px;"> (3) </font> </a> </li>

							<li type="disc" style="margin-left: 30px; color: gray;">

								<a href="#" style="color: blue"> Ferretería <font style="color:gray; font-size: 11px;"> (1) </font> </a> </li>
                  ...
                  <ul style="margin: 0.8em 0 0.8em 0;">
                  	...
                  	<li type="disc" style="margin-left: 30px; color: gray;"> 
								...
								<a href="#" style="color: blue"> Bogotá <font style="color:gray; font-size: 11px;"> (<?= @$bogota;?>) </font> </a> </li>
                  ...
                  <ul style="margin: 0.8em 0 0.8em 0;">
                  	...
                  	<li type="disc" style="margin-left: 30px; color: gray;"> 
								...
								<a href="#" style="color: blue"> Medellín <font style="color:gray; font-size: 11px;"> (<?= @$medellin;?>) </font> </a> </li>
				...
				<div class="grid_4" id="div3">
					...
					<!-- div de informacion (dinamico, cambia segun la pestaña seleccionada) -->
					...
					<div class="grid_2 alpha" style="width: 63em; height: auto; background: white;">
						...
						<p id="titulo_cont">
							...
							Venta al por mayor de cobre en Colombia - Precio y catálogo de productos

						</p>

						<p id="subtitulo_cont">

							Se muestra a continuación el catálogo de productos al por mayor de venta 
					...
					<!-- div que maneja el sistema de pestañas -->
					...
					<div class="grid_4" id="preg_satis">
						...
						<!-- mediante jquery, al cambiar de pestaña -->
