...
$(document).ready(function() {
  //show sub-categories of a selected category
    $("#textarea1").change(function() {
      $("#textarea1 option:selected").each(function() {
        ...
        $.post(base_url+"herramientas/subcategorias/"+categoria, {
          categoria: categoria
        }, function(data) {
          $("#textarea2").html(data);
  ...
  //put in "seleccionados" selected category and sub-category
    $("#agregar").click(function() {
      ...
      var start=subcategoria.lastIndexOf('(')+1;
      var end=subcategoria.lastIndexOf(')');
      var id_subcategoria = subcategoria.substring(start,end);
      $("#cat_selecc").text(categoria); 
      $('input[name=categoria]').val(categoria);
      $("#subcat_selecc").text(subcategoria); 
      $('input[name=subcategoria]').val(id_subcategoria);  
    });
  ...
  //cargar cantidades en select de "cantidad requerida" 
    $("#cantidad_format").on('input', function() {
      ...
      $("#combo1").load(base_url + "herramientas/unidad_medida/"+cantidad);
    });
 ...
 //script para mostrar/ocultar el select de  "municipios" cuando se selecc un depto
    $('#departamento').change(function () {
      selecDep = $("#departamento").find(":selected").val();
      if (selecDep == "") {
      ...
      $("#municipio").load(base_url + "herramientas/municipios/"+departamento);
